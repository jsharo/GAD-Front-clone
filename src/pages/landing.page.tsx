...
const STATUS_INFO: Record<string, { label: string; color: string; bg: string; step: number }> = {
  BORRADOR: { label: 'Borrador (Pendiente Envío)', color: '#6B7280', bg: '#F3F4F6', step: 1 },
  PENDIENTE_SECRETARIA: { label: 'Enviado (Espera Validación Documental)', color: '#F59E0B', bg: 'rgba(245,158,11,0.1)', step: 1 },
  OBSERVADO: { label: 'Observado por Secretaría (Devuelto)', color: '#EF4444', bg: 'rgba(239,68,68,0.1)', step: 2 },
  EN_REVISION_TECNICA: { label: 'En Revisión Técnica', color: '#3B82F6', bg: 'rgba(59,130,246,0.1)', step: 2 },
  PENDIENTE_PAGO: { label: 'Aprobado (Pendiente de Pago)', color: '#F59E0B', bg: 'rgba(245,158,11,0.1)', step: 3 },
...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen text-neutral-800 bg-neutral-100 font-sans">
      ...
      {/* NAVBAR PROTOTIPO */}
      <nav className="bg-neutral-50 border-b border-neutral-200 sticky top-0 z-50 shadow-sm transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center justify-center flex-1 max-w-xs mx-8">
            <div className="relative w-full">
              ...
              <input 
                ...
                className="w-full pl-9 pr-4 py-1.5 rounded-full bg-neutral-100 border border-transparent focus:bg-neutral-50 focus:border-primary-default text-xs outline-none transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Link to="/auth/signin" className="flex items-center gap-1.5 text-xs font-bold text-neutral-700 hover:text-primary-default transition-colors">
              <span className="w-5 h-5 flex items-center justify-center border border-neutral-300 rounded-lg text-neutral-500">→</span>
              Sign In
            </Link>
            <Link to="/auth/signup" className="inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-bold rounded-xl bg-primary-default hover:bg-primary-dark text-neutral-50 shadow-md transition-all">
              Sign Up
            </Link>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-100 bg-neutral-50/95">
          <div className="max-w-7xl mx-auto px-6 py-2.5 flex items-center justify-start gap-8 overflow-x-auto text-xs font-bold tracking-wider text-neutral-600">
            <a href="#inicio" className="text-primary-default border-b-2 border-secondary-light pb-1 hover:text-primary-dark">INICIO</a>
            <a href="#servicios" className="hover:text-primary-default transition-colors">TRÁMITES TÉCNINES</a>
            <a href="#seguimiento" className="hover:text-primary-default transition-colors">CONSULTA EXPEDIENTES</a>
            <a href="#registro-profesional" className="hover:text-primary-default transition-colors">HABILITACIÓN PROFESIONAL</a>
            <a href="#noticias" className="hover:text-primary-default transition-colors">NOTICIAS GAD</a>
          </div>
        </div>
      </nav>

      {/* HERO SECTION CLARO */}
      <section id="inicio" className="relative overflow-hidden bg-gradient-to-b from-primary-light/10 via-neutral-100 to-neutral-50 py-16 lg:py-24 border-b border-neutral-100">
        {/* Glow de fondo */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-primary-light/20 blur-[120px] pointer-events-none -mr-40" />
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full"
              style={{ background: 'rgba(59,130,246,0.06)', border: '1px solid rgba(59,130,246,0.12)', color: '#3B82F6', fontSize: '0.75rem', fontWeight: 600 }}>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link to="/login" className="inline-flex items-center justify-center gap-2 text-base px-8 py-3.5 rounded-xl bg-primary-default hover:bg-primary-dark text-neutral-50 font-bold shadow-lg transition-all">
                Ingresar al Portal
                <ArrowRight size={18} />
              </Link>
              <a href="#registro-profesional" className="inline-flex items-center justify-center gap-2 text-base px-8 py-3.5 rounded-xl border border-primary-default/30 text-primary-default font-semibold hover:bg-primary-default/5 transition-all">
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4 text-xs font-bold text-neutral-500">
              <span className="flex items-center gap-1.5"><CheckCircle2 size={15} className="text-primary-light" /> Firma Electrónica (XAdES-BES)</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 size={15} className="text-success-default" /> Revisión Ágil</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 size={15} className="text-warning-default" /> Trazabilidad Completa</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center py-8 lg:py-0">
            ...
            <div className="absolute w-72 h-72 rounded-full bg-primary-light/20 blur-3xl" />
            
            {/* Escudo del GAD Cañar en el centro */}
            <div className="relative z-10 w-44 h-56 bg-neutral-50/70 backdrop-blur-sm p-4 rounded-3xl border border-neutral-50/60 shadow-xl flex items-center justify-center">
              <img
                src="/logo-gad.png"
                alt="Escudo de Cañar"
            ...
            <div className="absolute top-6 left-6 z-20 bg-neutral-50/95 backdrop-blur-sm border border-neutral-100 rounded-2xl px-4 py-2.5 shadow-lg flex flex-col items-start min-w-[100px] text-left hover:scale-105 transition-transform">
              <span className="text-primary-default font-extrabold text-sm leading-none">3,200+</span>
              <span className="text-neutral-500 text-[10px] font-bold mt-0.5">Planos Aprobados</span>
            </div>

            {/* Tarjeta Flotante 2 (Promedio) */}
            <div className="absolute bottom-6 left-6 z-20 bg-neutral-50/95 backdrop-blur-sm border border-neutral-100 rounded-2xl px-4 py-2.5 shadow-lg flex flex-col items-start min-w-[100px] text-left hover:scale-105 transition-transform">
              <span className="text-warning-default font-extrabold text-sm leading-none">48h</span>
              <span className="text-neutral-500 text-[10px] font-bold mt-0.5">Revisión Técnica</span>
            </div>

            {/* Tarjeta Flotante 3 (Satisfacción) */}
            <div className="absolute bottom-12 right-2 z-20 bg-neutral-50/95 backdrop-blur-sm border border-neutral-100 rounded-2xl px-4 py-2.5 shadow-lg flex flex-col items-start min-w-[110px] text-left hover:scale-105 transition-transform">
      ...
      <section id="seguimiento" className="py-12 bg-neutral-50 border-b border-neutral-100">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-neutral-100 border border-neutral-200/80 p-6 sm:p-8 rounded-3xl shadow-sm relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-error-default via-secondary-light to-success-default" />
                ...
                <form onSubmit={handleTrack} className="space-y-3">
                  <div className="relative">
                    <input
                      id="trackInput"
                      type="text"
                      className="w-full pl-4 pr-12 py-3.5 bg-neutral-50 border border-neutral-200 text-neutral-800 placeholder-neutral-400 focus:border-primary-default focus:ring-2 focus:ring-primary-default/15 text-xs rounded-2xl outline-none transition-all"
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 w-9 h-9 rounded-xl bg-primary-default hover:bg-primary-dark text-neutral-50 flex items-center justify-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
      ...
      <section id="registro-profesional" className="py-16 max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl font-extrabold text-neutral-900">Registro y Habilitación de Firmas Técnicas</h2>
        ...
        <div className="max-w-3xl mx-auto bg-neutral-50 border border-neutral-200/80 rounded-3xl p-6 sm:p-8 shadow-sm hover:border-primary-default hover:shadow-md transition-all flex flex-col sm:flex-row items-start sm:items-center gap-6 text-left">
          <div className="p-4 rounded-2xl bg-primary-light/10 text-primary-default flex-shrink-0">
            <CheckCircle2 size={36} />
          </div>
          <div className="space-y-3 flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h3 className="font-bold text-neutral-800 text-lg">Registro de Profesional Acreditado</h3>
            ...
            <div className="pt-2">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 text-xs font-bold rounded-xl bg-neutral-900 hover:bg-neutral-800 text-neutral-50 shadow-none border-none transition-all"
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {STATS.map((s) => (
              <div key={s.label} className="text-center">
                ...
                <p className="text-xs text-neutral-500 uppercase tracking-wider font-bold">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="servicios" className="py-20 max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-extrabold text-neutral-900">Trámites Técnicos Habilitados</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {FEATURES.map((f) => (
            <div key={f.title} className="p-6 rounded-3xl bg-neutral-50 border border-neutral-200/60 shadow-sm flex flex-col items-start space-y-4 text-left hover:shadow-md transition-shadow">
      ...
      {is_modal_open && tracking_result && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-neutral-900/40 backdrop-blur-sm" onClick={() => set_is_modal_open(false)} />
          
          <div className="relative w-full max-w-2xl bg-neutral-50 rounded-3xl shadow-2xl p-6 overflow-hidden animate-slide-up max-h-[90vh] flex flex-col text-left">
            <div className="flex items-center justify-between border-b pb-4 mb-4">
              <div>
                <h3 className="text-xl font-bold text-neutral-900">Estado de Trámites</h3>
                {citizen && (
                  <p className="text-xs text-neutral-500">Propietario: {citizen.first_name} {citizen.last_name}</p>
                )}
              </div>
              <button
                onClick={() => set_is_modal_open(false)}
                className="w-8 h-8 rounded-full bg-neutral-100 hover:bg-neutral-200 text-neutral-600 font-bold flex items-center justify-center transition-colors text-sm"
              >
                ✕
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto space-y-6 pr-1">
              {applications.map((sol: any) => {
                ...
                return (
                  <div key={sol.id} className="p-5 rounded-2xl bg-neutral-100 border border-neutral-200/60 space-y-4">
                    ...
                    <div className="pt-2">
                      <div className="relative flex justify-between items-center max-w-md mx-auto">
                        ...
                        <div className="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-primary-default z-0 transition-all duration-500" 
                        ...
                        {[
                          ...
                          if (is_past) {
                            ...
                            ring_class = 'ring-4 ring-primary-default/20'
                          }
                          ...
                          return (
                            <div key={s.num} className="flex flex-col items-center relative z-10">
                              ...
                              <span className={`text-[10px] mt-1.5 font-bold ${is_active ? 'text-primary-default' : 'text-neutral-500'}`}>
                                {s.label}
                              </span>
                            </div>
                          )
                    ...
                    {sol.status === 'PENDIENTE_PAGO' && sol.payment && (
                      <div className="p-3.5 rounded-xl bg-warning-light/20 border border-warning-light text-warning-dark text-xs flex justify-between items-center">
                        ...
                        <span className="text-lg font-black text-warning-default">${sol.payment.amount}</span>
                      </div>
                    )}
