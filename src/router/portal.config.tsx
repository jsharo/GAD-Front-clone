...
export const PORTAL_CONFIGS: PortalConfig[] = [
  {
    role: 'ADMINISTRATOR',
    base_path: '/admin',
    panel_label: 'ADMINISTRATION PANEL',
    ...
    badge_icon: Shield,
    badge_label: 'Administrator',
    nav_items: [
      { to: '/admin', icon: LayoutDashboard, label: 'Dashboard', end: true },
      { to: '/admin/applications', icon: FileText, label: 'All Applications' },
      { to: '/admin/users', icon: Users, label: 'Users and Technicians' },
  ...
  },
  {
    role: 'USER',
    base_path: '/architect',
    panel_label: 'PROFESSIONAL PORTAL',
    ...
    nav_items: [
      { to: '/architect', icon: LayoutDashboard, label: 'Home', end: true },
      { to: '/architect/procedures', icon: FileText, label: 'My Applications', end: true },
      { to: '/architect/procedures/new', icon: PlusCircle, label: 'New Application', end: true },
    ],
    child_routes: [
  ...
  },
  {
    ...
    badge_icon: Stamp,
    badge_label: 'Secretary',
    nav_items: [
      { to: '/secretary', icon: LayoutDashboard, label: 'Dashboard', end: true },
      { to: '/secretary/inbox', icon: Inbox, label: 'Application Inbox' },
      { to: '/secretary/technicians', icon: MapPin, label: 'Technicians and Zones' },
      { to: '/secretary/architects', icon: HardHat, label: 'Architect Approval' },
      { to: '/secretary/history', icon: History, label: 'History' },
    ],
    child_routes: [
  ...
  },
  {
    ...
    badge_icon: Wrench,
    badge_label: 'Technician',
    nav_items: [
      { to: '/technician', icon: LayoutDashboard, label: 'Dashboard', end: true },
      { to: '/technician/inbox', icon: Inbox, label: 'Work Inbox' },
    ],
    child_routes: [
  ...
  },
  {
    ...
    nav_items: [{ to: '/financial', icon: Landmark, label: 'Home', end: true }],
    child_routes: [{ index: true, element: <ModulePlaceholder title="Financial Portal" /> }],
  },
  {
    role: 'CITIZEN',
    base_path: '/citizen',
    panel_label: 'CITIZEN PORTAL',
    ...
    badge_label: 'Citizen',
    nav_items: [{ to: '/citizen', icon: UserRound, label: 'Home', end: true }],
    child_routes: [{ index: true, element: <ModulePlaceholder title="Citizen Portal" /> }],
  },
];
